...
<head>
    ...
    <title>CFA SHOP | <?= $_SESSION['lang'] == 'fr' ? 'Accessoires' : 'Accessories'; ?></title>
...
<body>
        ...
        <div class="container-fluid px-4">
            ...
            <div class="d-none d-lg-flex flex-grow-1 justify-content-center px-4">
                <div class="input-group search-bar border rounded-pill overflow-hidden max-w-md">
                    <input type="text" class="form-control border-0 px-4" placeholder="<?= isset($lang['recherche_accessoire']) ? $lang['recherche_accessoire'] : $lang['recherche']; ?>">
    ...
    <div id="headerCarousel" class="carousel slide carousel-fade pt-20" data-bs-ride="carousel" data-bs-interval="3000">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    <h2 class="text-5xl md:text-7xl font-black text-white mb-6 uppercase"><?= isset($lang['titre_carousel_4']) ? $lang['titre_carousel_4'] : 'TRES LEGER'; ?></h2>
                    <p class="bg-white text-black px-8 py-3 font-bold uppercase tracking-widest hover:bg-black hover:text-white transition"><?= isset($lang['texte_carousel_4']) ? $lang['texte_carousel_4'] : 'Doux et Agréable'; ?></p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="9ceca8b4bed75c11116a3bd0964a8b78.jpg" alt="Collection 5">
                <div class="carousel-caption">
                    <h2 class="text-5xl md:text-7xl font-black text-white mb-6 uppercase"><?= isset($lang['titre_carousel_5']) ? $lang['titre_carousel_5'] : 'Meilleure Qualité'; ?></h2>
                    <p class="bg-white text-black px-8 py-3 font-bold uppercase tracking-widest hover:bg-black hover:text-white transition"><?= isset($lang['texte_carousel_5']) ? $lang['texte_carousel_5'] : 'Simplicité de Jeunesse'; ?></p>
                </div>
            </div>
        </div>
    ...
    <main class="container-fluid px-4 py-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <?php
            // Récupérer uniquement les articles de la catégorie 'accessoires'
            $requete = $db->query("SELECT * FROM articles WHERE categorie = 'accessoires' ORDER BY id DESC");
