...
<head>
    ...
    <title>CFA SHOP | <?= $_SESSION['lang'] == 'fr' ? 'Collection Enfants' : 'Kids Collection'; ?></title>
...
<body>
        ...
        <div class="container-fluid px-4">
            ...
            <div class="d-none d-lg-flex flex-grow-1 justify-content-center px-4">
                <div class="input-group search-bar border rounded-pill overflow-hidden max-w-md">
                    <input type="text" class="form-control border-0 px-4" placeholder="<?= isset($lang['recherche_enfant']) ? $lang['recherche_enfant'] : $lang['recherche']; ?>">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="deconnexion.php" class="bg-red-600 text-white px-3 py-2 text-xs font-bold uppercase tracking-widest transition hover:bg-red-700 hidden md:inline-block"><?= $lang['deconnexion']; ?></a>
            </div>
        </div>
    </nav>
    ...
    <div id="headerCarousel" class="carousel slide carousel-fade pt-20" data-bs-ride="carousel" data-bs-interval="3000">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="db330779d812f79d32d950e9e98a7383.jpg" alt="Collection 1">
            ...
            <div class="carousel-item">
                <img src="R (1).jpg" alt="Collection 2">
                <div class="carousel-caption">
            ...
            <div class="carousel-item">
                <img src="80885d078fa6f76a02bf58ee260aaed8.jpg" alt="Collection 3">
                <div class="carousel-caption">
                    <h2 class="text-5xl md:text-7xl font-black text-white mb-6 uppercase">BOY & GIRL</h2>
            ...
            <div class="carousel-item">
                <img src="27ae8a18959809a7f86a51839a934054.jpg" alt="Collection 4">
                <div class="carousel-caption">
                    <h2 class="text-5xl md:text-7xl font-black text-white mb-6 uppercase"><?= isset($lang['titre_carousel_4_enfant']) ? $lang['titre_carousel_4_enfant'] : 'TRES LEGER'; ?></h2>
                    <p class="bg-white text-black px-8 py-3 font-bold uppercase tracking-widest hover:bg-black hover:text-white transition"><?= isset($lang['texte_carousel_4_enfant']) ? $lang['texte_carousel_4_enfant'] : 'Doux et Agréable'; ?></p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="9ceca8b4bed75c11116a3bd0964a8b78.jpg" alt="Collection 5">
                <div class="carousel-caption">
                    <h2 class="text-5xl md:text-7xl font-black text-white mb-6 uppercase"><?= isset($lang['titre_carousel_5_enfant']) ? $lang['titre_carousel_5_enfant'] : 'Meilleure Qualité'; ?></h2>
                    <p class="bg-white text-black px-8 py-3 font-bold uppercase tracking-widest hover:bg-black hover:text-white transition"><?= isset($lang['texte_carousel_5_enfant']) ? $lang['texte_carousel_5_enfant'] : 'Simplicité de Jeunesse'; ?></p>
                </div>
            </div>
        </div>
    ...
    <main class="container-fluid px-4 py-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <?php
            // Récupérer uniquement les articles de la catégorie 'enfants'
            $requete = $db->query("SELECT * FROM articles WHERE categorie = 'enfants' ORDER BY id DESC");
