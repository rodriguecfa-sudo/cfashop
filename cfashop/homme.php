...
<head>
    ...
    <title>CFA SHOP | <?= $_SESSION['lang'] == 'fr' ? 'Collection Homme' : 'Men Collection'; ?></title>
...
<body>
    ...
    <div id="headerCarousel" class="carousel slide carousel-fade pt-20" data-bs-ride="carousel" data-bs-interval="3000">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="photo-1490578474895-699cd4e2cf59.jpg" alt="Collection 1">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    <h2 class="text-5xl md:text-7xl font-black text-white mb-6 uppercase"><?= $lang['titre_carousel_3']; ?></h2>
            ...
            <div class="carousel-item">
                <img src="7f5de7a031d0ca2084d5a652849f287b.jpg" alt="Collection 4">
                <div class="carousel-caption">
                    <h2 class="text-5xl md:text-7xl font-black text-white mb-6 uppercase"><?= isset($lang['titre_carousel_3_homme']) ? $lang['titre_carousel_3_homme'] : 'Pure Coton'; ?></h2>
                    <p class="bg-white text-black px-8 py-3 font-bold uppercase tracking-widest hover:bg-black hover:text-white transition"><?= isset($lang['texte_carousel_3_homme']) ? $lang['texte_carousel_3_homme'] : 'Doux et Agréable'; ?></p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="0eef1950382298f6a638d1ed3efac140.jpg" alt="Collection 5">
                <div class="carousel-caption">
    ...
    <main class="container-fluid px-4 py-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <?php
            // Récupérer uniquement les articles de la catégorie 'homme'
            $requete = $db->query("SELECT * FROM articles WHERE categorie = 'homme' ORDER BY id DESC");
